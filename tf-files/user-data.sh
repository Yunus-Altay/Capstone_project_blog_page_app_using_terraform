...
git https://$TOKEN@github.com/Yunus-Altay/Capstone_project_blog_page_app_using_terraform.git
...
sed -i "s/'bucket_id'/'${content_bucket_name}-encryption-service'/g" settings.py
